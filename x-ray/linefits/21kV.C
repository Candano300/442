...
data->Fit(linefit, "R", "", 0.055, 0.070);
linefit->Draw("SAME");
...
c1->SaveAs("../outputs/linefits/images/svg/21kV.png");
c1->SaveAs("../outputs/linefits/images/pdf/21kV.pdf");
c1->Close();
