...
datapoints->SetTitle("Linefit at 27kV");
...
TF1* linefit = new TF1("linefit", "[0]*x+[1]", 0.01, 0.09);
linefit->SetLineWidth(5);
linefit->SetLineColor(kRed);
linefit->SetMarkerStyle(8);
data->Fit(linefit, "R", "", 0.046, 0.064);
linefit->Draw("SAME");
...
c1->SaveAs("../outputs/linefits/images/svg/27kV.png");
c1->SaveAs("../outputs/linefits/images/pdf/27kV.pdf");
c1->Close();
}