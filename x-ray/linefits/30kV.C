...
datapoints->SetTitle("Linefit at 30kV");
...
TF1* linefit = new TF1("linefit", "[0]*x+[1]", 0.040, 0.9);
linefit->SetLineWidth(5);
linefit->SetLineColor(kRed);
linefit->SetMarkerStyle(8);
data->Fit(linefit, "R", "", 0.043, 0.053);
...
c1->SaveAs("../outputs/linefits/images/svg/30kV.png");
c1->SaveAs("../outputs/linefits/images/pdf/30kV.pdf");
c1->Close();
}