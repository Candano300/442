...
datapoints->SetTitle("Linefit at 24kV");
...
TF1* linefit = new TF1("linefit", "[0]*x+[1]", 0.01, 0.1);
linefit->SetLineWidth(5);
linefit->SetLineColor(kRed);
linefit->SetMarkerStyle(8);
data->Fit(linefit, "R", "", 0.051, 0.074);
linefit->Draw("SAME");
...
c1->SaveAs("../outputs/linefits/images/svg/24kV.png");
c1->SaveAs("../outputs/linefits/images/pdf/24kV.pdf");
c1->Close();
